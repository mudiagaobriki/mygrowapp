...
function FootballController(){
    ...
    const getCurrentRound = (req, res) => {
        ...
        axios.request(options).then(function (response) {
            console.log(response.data);
            fs.writeFile('./storage/fixtures/current-round.json', JSON.stringify(response.data), (err) => {
                if (err) {
                    // throw err;
                    res.send({
                        status: 'error',
    ...
    const currentFixtures = (req, res) => {
        ...
        axios.request(options).then(function (response) {
            console.log(response.data);
            fs.writeFile('./storage/fixtures/current-fixtures.json', JSON.stringify(response.data), (err) => {
                if (err) {
                    // throw err;
                    res.send({
                        status: 'error',
    ...
    const nextFixtures = (req, res) => {
        ...
        axios.request(options).then(function (response) {
            console.log(response.data);
            fs.writeFile('./storage/fixtures/next-50-fixtures.json', JSON.stringify(response.data), (err) => {
                if (err) {
                    // throw err;
                    res.send({
                        status: 'error',
    ...
    const currentRoundFixtures = (req, res) => {
        ...
        axios.request(options).then(function (response) {
            console.log(response.data);
            fs.writeFile('./storage/fixtures/current-round-fixtures.json', JSON.stringify(response.data), (err) => {
                if (err) {
                    // throw err;
                    res.send({
                        status: 'error',
    ...
    const oddsById = (req, res) => {
        ...
        fs.readFile('./storage/fixtures/today-odds.json', (err, data) => {
            ...
            console.log({ odds })
            let odd = odds?.response?.find(el => Number(el.fixture?.id) === Number(id) )
    ...
    const predictionById = (req, res) => {
        ...
        fs.readFile('./storage/fixtures/today-predictions.json', (err, data) => {
            ...
            prediction = prediction.find(el => Number(el.fixtureId) === Number(fixtureId) )
            console.log({ prediction })
    ...
    return { getAllLeagues, getLeaguesById, leagueByTeamId, leagueBySeason, getAllFixtures, getCurrentRound,
        currentFixtures, nextFixtures, yesterdayFixtures, todayFixtures, tomorrowFixtures, timezones,
        todayOdds, tomorrowOdds, bookmakers, predictions, predictionById, oddsById }
}
